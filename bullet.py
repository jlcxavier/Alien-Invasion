...
class Bullet(Sprite):
	...
	def __init__(self, c_settings, screen, ship):
		...
		# posição correta
		self.rect = pygame.Rect(0, 0, c_settings.bullet_width,
			c_settings.bullet_height)
		...
		self.color = c_settings.bullet_color
		self.speed_factor = c_settings.bullet_speed_factor
