...
class Alien(Sprite):
	"""Uma classe que representaum único alienígena da frota."""
	...
	def __init__(self, c_settings, screen):
		...
		# Inicia cada novo alienígena próxima a parte superior esquerda da tela
	...
	def update(self):
		...
		self.x += (self.c_settings.alien_speed_factor *
			self.c_settings.fleet_direction)
		self.rect.x = self.x
