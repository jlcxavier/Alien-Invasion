...
class Scoreboard():
    ...
    def __init__(self, c_settings, screen, stats):
    ...
    def prep_score(self):
        ...
        self.score_image = self.font.render(
            score_str, True, self.text_color, self.c_settings.bg_color)
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render(high_score_str, True,
                                                 self.text_color, self.c_settings.bg_color)
    ...
    def prep_ships(self):
        ...
        for ship_number in range(self.stats.ships_left):
            ship = Ship(self.c_settings, self.screen)
