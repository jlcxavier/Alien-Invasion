...
def check_aliens_bottom(c_settings, screen, stats, sb, ship, aliens, bullets):
    """Verifica se algum alienígena alcançou a parte inferior da tela."""
    screen_rect = screen.get_rect()
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom:
            # Trata esse caso do mesmo modo que é feito quando uma espaçonave é atingida
            ship_hit(c_settings, screen, stats, sb, ship, aliens, bullets)
            break
...
def update_aliens(c_settings, stats, screen, sb, ship, aliens, bullets):
    """
    ...
    check_aliens_bottom(c_settings, screen, stats, sb, ship, aliens, bullets)


def ship_hit(c_settings, screen, stats, sb, ship, aliens, bullets):
